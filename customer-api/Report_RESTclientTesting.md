...
````
![GET All Customers](./output/client_testing/test1.png)
...
````
![GET Customer by ID](./output/client_testing/test2.png)
...
````
![POST Create New Customer](./output/client_testing/test3.png)
...
````
![PUT Update Customer](./output/client_testing/test4.png)
...
````
![DELETE Customer](./output/client_testing/test5.png)
...
````
![Search Customers](./output/client_testing/test6.png)
...
````
![Validation Error](./output/client_testing/test7.png)
...
````
![Resource Not Found](./output/client_testing/test8.png)
...
````
![Duplicate Resource](./output/client_testing/test9.png)